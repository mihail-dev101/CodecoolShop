...
namespace Codecool.CodecoolShop
{
    public class EmailSender
    {
        ...
        {//                                                 this key was generated by send grid, DO NOT TOUCH!!!
            ...
            var to = new EmailAddress(reciever, "Example User"); // this is also my mail (alin) should take the users mail
            ...
            var htmlContent = "<strong>Thanks for purchasing from our site</strong>"; // this is the actual content of the mail, written like html we can add products and everything we need
